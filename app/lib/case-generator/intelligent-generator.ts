  ...
  const scenes: Scene[] = [
    {
      ...
      locationType: seed.location.type || 'indoor',
    ...
    },
    {
      ...
      description: 'A quiet space to review evidence, interview suspects, and piece together the mystery. Bulletin boards line the walls with case information.',
      locationType: 'office',
