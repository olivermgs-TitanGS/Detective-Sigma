...
export const p4MathTopics: SyllabusTopic[] = [
  ...
  // MEASUREMENT STRAND
  {
    ...
    strand: 'measurement',
    unit: 'Time',
    description: 'Reading time, calculating duration, converting time units.',
    learningObjectives: [
      { id: 'p4-time-1', description: 'Read and write time in 24-hour notation', bloomsLevel: 'apply' },
      { id: 'p4-time-2', description: 'Convert between 12-hour and 24-hour notation', bloomsLevel: 'apply' },
      { id: 'p4-time-3', description: 'Calculate duration in hours and minutes', bloomsLevel: 'apply' },
      { id: 'p4-time-4', description: 'Solve word problems involving time', bloomsLevel: 'analyze' },
    ],
    prerequisites: [],
    keyVocabulary: ['a.m.', 'p.m.', '24-hour clock', 'duration', 'hours', 'minutes', 'seconds'],
    estimatedLessons: 8,
    puzzleTypes: ['time-calculation', 'schedule-analysis', 'duration-problem'],
    realWorldApplications: ['Travel schedules', 'Event planning', 'Cooking times'],
  },
  {
...
export const p5MathTopics: SyllabusTopic[] = [
  ...
  },
  {
    ...
    learningObjectives: [
      { id: 'p5-rat-1', description: 'Use ratio to compare quantities', bloomsLevel: 'understand' },
      { id: 'p5-rat-2', description: 'Find equivalent ratios', bloomsLevel: 'apply' },
      { id: 'p5-rat-3', description: 'Simplify ratios to simplest form', bloomsLevel: 'apply' },
      { id: 'p5-rat-4', description: 'Find one quantity given the ratio and another quantity', bloomsLevel: 'analyze' },
      { id: 'p5-rat-5', description: 'Solve word problems involving ratio', bloomsLevel: 'analyze' },
    ],
  ...
  },
  {
    ...
    learningObjectives: [
      { id: 'p5-avg-1', description: 'Find average of a set of numbers', bloomsLevel: 'apply' },
      { id: 'p5-avg-2', description: 'Find total given average and number of items', bloomsLevel: 'analyze' },
      { id: 'p5-avg-3', description: 'Find missing value given average', bloomsLevel: 'analyze' },
      { id: 'p5-avg-4', description: 'Solve word problems involving average', bloomsLevel: 'analyze' },
    ],
    prerequisites: ['p4-math-multiplication'],
  ...
  },
  {
    ...
    prerequisites: ['p5-math-ratio'],
    keyVocabulary: ['rate', 'per', 'unit rate', 'speed'],
    estimatedLessons: 8,
...
export const p6MathTopics: SyllabusTopic[] = [
  ...
  },
  {
    ...
    prerequisites: ['p5-math-fractions', 'p5-math-ratio'],
  ...
  },
  {
    ...
    prerequisites: ['p5-math-ratio', 'p5-math-percentage'],
  ...
  },
  {
    ...
    strand: 'measurement',
    unit: 'Speed',
    description: 'Speed, distance, time relationships and problems.',
    learningObjectives: [
      { id: 'p6-spd-1', description: 'Calculate speed given distance and time', bloomsLevel: 'apply' },
      { id: 'p6-spd-2', description: 'Calculate distance given speed and time', bloomsLevel: 'apply' },
      { id: 'p6-spd-3', description: 'Calculate time given speed and distance', bloomsLevel: 'apply' },
      { id: 'p6-spd-4', description: 'Convert between units of speed', bloomsLevel: 'apply' },
      { id: 'p6-spd-5', description: 'Solve complex speed problems (meeting, catching up)', bloomsLevel: 'analyze' },
    ],
    prerequisites: ['p5-math-rate'],
    keyVocabulary: ['speed', 'distance', 'time', 'km/h', 'm/s', 'average speed'],
    estimatedLessons: 12,
    puzzleTypes: ['speed-calculation', 'meeting-problem', 'catching-up-problem'],
    realWorldApplications: ['Travel planning', 'Sports timing', 'Traffic analysis'],
  },
  {
    id: 'p6-math-circles',
    name: 'Circles',
...
export const p5ScienceTopics: SyllabusTopic[] = [
  ...
  },
  {
    ...
    strand: 'systems',
    unit: 'Cells',
    description: 'Cells as the basic unit of life.',
    learningObjectives: [
      { id: 'p5-cel-1', description: 'Identify the cell as the basic unit of life', bloomsLevel: 'remember' },
      { id: 'p5-cel-2', description: 'Identify parts of plant and animal cells', bloomsLevel: 'remember' },
      { id: 'p5-cel-3', description: 'Compare plant and animal cells', bloomsLevel: 'analyze' },
    ],
    prerequisites: [],
    keyVocabulary: ['cell', 'nucleus', 'cell membrane', 'cell wall', 'cytoplasm', 'chloroplast', 'vacuole'],
    estimatedLessons: 6,
    puzzleTypes: ['cell-part-identification', 'cell-comparison', 'function-matching'],
    realWorldApplications: ['Microscopy', 'Medicine', 'Biology research'],
  },
...
export const p6ScienceTopics: SyllabusTopic[] = [
  ...
  // INTERACTIONS
  {
    ...
    prerequisites: [],
    keyVocabulary: ['force', 'gravity', 'friction', 'magnetic force', 'push', 'pull', 'newton'],
    estimatedLessons: 10,
